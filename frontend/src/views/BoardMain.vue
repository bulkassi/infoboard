  ...
  <div class="w-full overflow-x-auto">
    ...
    >
      <div
        ...
        :key="card.id"
        class="board-card"
        :class="{ 'board-card--editable': canEdit }"
...
const cards = [
  {
    id: 'card-1',
    imageSrc: 'https://i.pinimg.com/originals/19/fc/fb/19fcfbb5debcb7d95a5f73a556a54b39.webp?nii=t',
    title: 'Карточка 1',
...
const getCardLayout = (cardId) => {
  return activeLayouts.value[cardId] ?? defaultLayouts[cardId]
}
